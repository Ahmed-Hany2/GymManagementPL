        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specialities = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUser_Email_Check", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("GymUser_Phone_Check", "Phone LIKE '01%' AND Phone NOT LIKE '%[^0-9]%'");
                });
