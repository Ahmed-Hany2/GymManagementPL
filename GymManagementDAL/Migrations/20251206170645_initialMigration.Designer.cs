...
namespace GymManagementDAL.Migrations
{
    ...
    [Migration("20251206170645_initialMigration")]
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable(t =>
                        {
                            t.HasCheckConstraint("GymUser_Email_Check", "Email LIKE '_%@_%._%'");

                            t.HasCheckConstraint("GymUser_Phone_Check", "Phone LIKE '01%' AND Phone NOT LIKE '%[^0-9]%'");
                        });
